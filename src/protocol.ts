...
const root = Root.fromJSON({nested: {ai: {nested: {edgez: {nested: {halow: {nested: {
  ...
  Peer: {fields: {id: T('uint64', 1), rssi: T('sint32', 2), sensorData: T('SensorData', 3, {rule: 'repeated'})}},
  ...
  NetworkPacket: {oneofs: {body: {oneof: ['payload', 'msg', 'status', 'init', 'deviceSettings', 'scriptConfig', 'beacon', 'report']}}, fields: {from: T('uint64', 1), to: T('uint64', 2), operation: T('Operation', 3), interface: T('Interface', 4), payload: T('bytes', 100), msg: T('MessageBody', 101), status: T('HaLowInterfaceStatus', 102), init: T('HaLowInitConfig', 103), deviceSettings: T('DeviceSettings', 104), scriptConfig: T('ScriptConfig', 105), beacon: T('Beacon', 106), report: T('Report', 107)}},
}}}}}}}});
